...
# encoding: utf-8
"""
Command Line interface to training with a given archmodel and data.

MonteFeatDictTrainer.py

Created by Matt Kayala on 2011-01-11.
...
from MonteArchModel import MonteArchModel, loadArchModel, saveArchModel;
from MonteFeatDictClassifier import MonteFeatDictClassifier;
from Util import accuracy, rmse;
from Const import EPSILON, MEMMAP_DTYPE;

from numpy import array, zeros, concatenate, min, max, where;

from Util import log;

class MonteFeatDictTrainer:
